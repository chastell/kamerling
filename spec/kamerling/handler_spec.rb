...
module Kamerling describe Handler do
  describe '#handle' do
    ...
    it 'handles RGST inputs' do
      ...
      registrar.must_have_received :register, [{ client_addr: addr,
    ...
    it 'handles RSLT inputs' do
      ...
      receiver.must_have_received :receive, [{ client_addr: addr, data: 'data',
        client_uuid: '16B client  UUID', task_uuid: '16B task    UUID' }]
    end
